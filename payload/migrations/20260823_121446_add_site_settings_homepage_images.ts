...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "site_settings" ADD COLUMN "homepage_about_image_id" integer;
  ...
  ALTER TABLE "site_settings" ADD CONSTRAINT "site_settings_homepage_about_image_id_media_id_fk" FOREIGN KEY ("homepage_about_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  CREATE INDEX "site_settings_homepage_homepage_about_image_idx" ON "site_settings" USING btree ("homepage_about_image_id");`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "site_settings" DROP CONSTRAINT "site_settings_homepage_about_image_id_media_id_fk";
  
  DROP INDEX "site_settings_homepage_homepage_about_image_idx";
  ALTER TABLE "site_settings" DROP COLUMN "homepage_about_image_id";`)
}
